...
if [ "$PACKAGE_VERSION" = "latest" ]; then
    PACKAGE_URL="https://github.com/mragicl/smartnode/raw/v0.0.4-rpi4/downloads/rp-smartnode-install-rpi4.tar.xz"
else
    PACKAGE_URL="https://github.com/mragicl/smartnode/raw/v0.0.4-rpi4/downloads/rp-smartnode-install-rpi4.tar.xz"
fi
...
{ mkdir -p "$RP_PATH/data/validators/lighthouse" || fail "Could not create the Rocket Pool user data directory."; } >&2
